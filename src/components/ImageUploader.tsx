...
export default function ImageUploader({ onImageSelected, isLoading }: ImageUploaderProps) {
  ...
  if (preview) {
    return (
      <div className="relative w-full max-w-2xl mx-auto rounded-xl overflow-hidden border border-zinc-800 bg-zinc-900/50 p-2">
  ...
  return (
    <div
      className={`w-full max-w-2xl mx-auto relative rounded-2xl border-2 border-dashed transition-all duration-200 ease-in-out ${
